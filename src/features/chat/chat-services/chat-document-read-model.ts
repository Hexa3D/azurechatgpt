 ...
 */
export const PrebuiltDocumentReadModel = fr.createModelFromSchema(
    modelInfo()
...
function modelInfo() {
    return {
        ...
        description: "Extract text, layout, entities, and general key-value pairs from Office documents.",
